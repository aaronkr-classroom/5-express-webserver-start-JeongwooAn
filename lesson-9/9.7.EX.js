...
app.get("/contact", homeController.getContact); // @TODO: homeController.getContact을 가져와 사용한다
app.post("/contact", homeController.postContact); // @TODO: homeController.postContact을 가져와 사용한다
